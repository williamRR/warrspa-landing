...
function ProductPreview() {
  return (
    <div className="relative">
      <div className="bg-bg-secondary border border-border rounded-2xl p-5 shadow-2xl">
      ...
      <div className="absolute -bottom-4 -left-6 bg-bg-secondary border border-border rounded-xl px-4 py-3 shadow-xl">
        <div className="text-xs text-text-muted">
          Proyectos propios en producción
        </div>
        <div className="text-sm font-bold text-text-primary font-display mt-0.5">
          MesaDigital · Y4
        </div>
      </div>

      <div className="absolute -top-3 -right-4 bg-primary text-bg-primary rounded-full px-3 py-1.5 text-xs font-bold shadow-lg">
        Santiago, Chile
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(#35D4C7 1px, transparent 1px), linear-gradient(90deg, #35D4C7 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[56px] font-extrabold text-text-primary leading-[1.1] tracking-tight mb-6 font-display">
              Diseñamos y desarrollamos software a medida{" "}
